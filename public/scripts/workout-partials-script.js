...
$(document).on("click", ".edit-name-button", function() {
...
$(document).on("click", ".cancel-name-button", function() {
    $(".partials-template-name").show();
    $(".partials-template-name-form").hide();
})

//Confirm edit name form
$(document).on("click", ".confirm-name-button", function() {
    //Set new name title
...
$(document).on("input", "#exercise-search-bar", function () {
...
$(document).on("click", "#submit-new-template", function() {
